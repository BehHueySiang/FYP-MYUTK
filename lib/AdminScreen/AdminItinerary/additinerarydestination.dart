...
class AddItineraryDestinationScreen extends StatefulWidget {
  ...
  const AddItineraryDestinationScreen(
      {super.key,
      required this.user,
      required this.destination,
      required this.tripinfo,
      required this.totaltripfee});

  @override
  State<AddItineraryDestinationScreen> createState() =>
      _AddItineraryDestinationScreenState();
}

class _AddItineraryDestinationScreenState
    extends State<AddItineraryDestinationScreen> {
  ...
  List<String> Statelist = ["Kedah", "Pulau Penang", "Perlis"];
  String Tripday = "1";
  List<String> Tripdaylist = ["1", "2", "3"];
                        ...
                        child: Container(
                            ...
                            child: Card(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    Des destination =
                                        Des.fromJson(Deslist[index].toJson());
  ...
  void _performSearch(String search, String searchstate) {
    http.post(Uri.parse("${MyConfig().SERVER}/MyUTK/php/load_des.php"), body: {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
            Text(
                "Do you want to add ${Deslist[index].desname} to which day of your trip itinerary?"),
            const SizedBox(
              height: 15,
            ),
            SizedBox(
