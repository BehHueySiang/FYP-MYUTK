...
class _EditTripItineraryScreenState extends State<EditTripItineraryScreen> {
 ...
 @override
  void initState() {
    ...
    print('Debug destination: ${widget.tripinfo.toJson()}');
                ...
                child: Card(
                  child: Container(
                      ...
                      child: CachedNetworkImage(
                          width: screenWidth,
                          fit: BoxFit.cover,
                          imageUrl:  "${MyConfig().SERVER}/myutk/assets/Hotel/${widget.tripinfo.tripid?.toString() ?? 'default'}_image.png?v=${DateTime.now().millisecondsSinceEpoch}",
