...
class AdmReviewListScreen extends StatefulWidget {
  final User user;

  const AdmReviewListScreen({
    super.key,
    required this.user,
  });

  @override
  State<AdmReviewListScreen> createState() => _AdmReviewListScreenState();
}

class _AdmReviewListScreenState extends State<AdmReviewListScreen> {
