...
class _addhotelscreenState extends State<addhotelscreen> {
  ...
  final TextEditingController _BookingUrlEditingController =
      TextEditingController();
  ...
  List<String> Statelist = ["Kedah", "Pulau Pinang", "Perlis"];
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    textInputAction: TextInputAction.next,
                    validator: (val) =>
                        val!.isEmpty || (val.length < 3) ? "" : null,
                    onFieldSubmitted: (v) {},
                    controller: _BookingUrlEditingController,
                    keyboardType: TextInputType.text,
                    decoration: const InputDecoration(
  ...
  void inserthotel() {
    ...
    String BookingUrl = _BookingUrlEditingController.text;
