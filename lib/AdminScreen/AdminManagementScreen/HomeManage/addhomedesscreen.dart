...
class AddHomeDesScreen extends StatefulWidget {
  final User user;
  final Des destination;
  const AddHomeDesScreen({super.key, required this.user, required this.destination,});

  @override
  State<AddHomeDesScreen> createState() => _AddHomeDesScreenState();
}

class _AddHomeDesScreenState extends State<AddHomeDesScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Text("Do you want to add ${Deslist[index].desname} to homescreen?"),
